...
function printOutput(num){
    if(num == ""){
        ...
        document.querySelector('.lower-value').innerHTML = getFormatterNumber(num);
    }
}
function getFormatterNumber(num){
    ...
    let n = Number(num);
    let value = n.toLocaleString("en"); //return a string with a representation of number
    return value;
}
function reverseNumberFormat(num){
    return Number(num.replace(/,/g,'')); //Give coma seperator value 
}
